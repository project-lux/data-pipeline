...
class GettyMapper(Mapper):
    ...
    def __init__(self, config):
        ...
        self.name_classifications = {
            ...
            "http://vocab.getty.edu/historic/localUse": vocab.AlternateName,
            "http://vocab.getty.edu/historic/historic": vocab.AlternateName,
            ...
            for i in rec["identified_by"]:
                if i["type"] == "Name":
                    ...
                    if nm:
                        ...
                        if (
                            not hasattr(top, "_label")
                            and isinstance(nm, vocab.PrimaryName)
                            and hasattr(nm, "language")
                            and nm.language[0].id == self.process_langs["en"]
                        ):
...
class UlanMapper(GettyMapper):
    def __init__(self, config):
        ...
        self.accept_values = ["http://vocab.getty.edu/aat/300386154"]
...
class TgnMapper(GettyMapper):
    def __init__(self, config):
        GettyMapper.__init__(self, config)
        self.accept_values = [
            "http://vocab.getty.edu/aat/300000771",
            "http://vocab.getty.edu/aat/300387506",
            "http://vocab.getty.edu/aat/300008372",
            "http://vocab.getty.edu/aat/300000774",
            "http://vocab.getty.edu/aat/300000776",
            "http://vocab.getty.edu/aat/300008389",
            "http://vocab.getty.edu/aat/300000745",
            "http://vocab.getty.edu/aat/300008694",
            "http://vocab.getty.edu/aat/300008375",
            "http://vocab.getty.edu/aat/300008057",
            "http://vocab.getty.edu/aat/300008791",
            "http://vocab.getty.edu/aat/300387218",
        ]
