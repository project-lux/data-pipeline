...
class WdFetcher(Fetcher):
    def validate_identifier(self, identifier):
        if (
            not identifier.startswith("Q")
            or not len(identifier) >= 2
    ...
    def post_process(self, js, identifier):
        ...
        if "prefLabel" in js and "description" in js and not "entities" in js:
            return js
            ...
            for val in vals:
                ...
                if dvt == "wikibase-entityid":
                    ...
                    dvv = {
                        ...
                        "long": dv["value"]["longitude"],
                        "alt": dv["value"]["altitude"],
                    }
                else:
