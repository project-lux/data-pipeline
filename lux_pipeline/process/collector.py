...
class Collector(object):
    ...
    def should_process_record(self, rec, xrec, equiv_recs):
        ...
        if rec["type"] == "Person" and xrec["type"] == "Person":
            ...
            if (
                "formed_by" in rec
                and "timespan" in rec["formed_by"]
                and "formed_by" in xrec
                and "timespan" in xrec["formed_by"]
            ):
                # Test dates are similar
            ...
            if (
                okay
                and "dissolved_by" in rec
                and "timespan" in rec["dissolved_by"]
                and "dissolved_by" in xrec
                and "timespan" in xrec["dissolved_by"]
            ):
            ...
            rec["type"] in ["MeasurementUnit", "Currency", "Language", "Material"]
            and xrec["type"] in ["MeasurementUnit", "Currency", "Language", "Material"]
            and xrec["type"] != rec["type"]
        ):
            okay = False
